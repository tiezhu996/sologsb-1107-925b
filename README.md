...
- `version(3)`：新增 `mouldRepairs` 修补记录表（纸帘、修补日期、修补人、换掉丝段长度、说明），登记修补即写入记录并把帘子置为“待修补”。
- 数据库首次创建时通过 `populate` 写入 5 张纸帘、4 条纸帘修补记录、5 个纤维料批、8 槽抄纸工序和 6 个成纸样本。
...
| `/moulds` | 纸帘台帐 | 筛选纸帘，登记新纸帘，实时推算网目密度；修补留档（修补人、日期、换丝长度、说明），列表显示累计次数与最近修补日期，待修补帘子自动退出抄纸工序下拉 |
